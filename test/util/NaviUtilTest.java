...
public class NaviUtilTest {
	...
	private final String page7Respect = 
			(new StringBuffer().append("<li class=\"prev\"><a href=\"user.do?page=6&amp;pageSize=10\">&lt;&lt;</a></li>")
							  .append("<li><a href=\"user.do?page=2&amp;pageSize=10\">2</a></li>")
							  .append("<li><a href=\"user.do?page=3&amp;pageSize=10\">3</a></li>")
							  .append("<li><a href=\"user.do?page=4&amp;pageSize=10\">4</a></li>")
							  .append("<li><a href=\"user.do?page=5&amp;pageSize=10\">5</a></li>")
							  ...
							  .append("<li class=\"next\"><a href=\"user.do?page=8&amp;pageSize=10\">&gt;&gt;</a></li>")).toString();
	...
	public void pageNavaiTest() {
		...
		/***Then***/
		assertEquals(page1Respect, NaviUtil.makePageNav("user.do", 202, 1, 10));
		assertEquals(page2Respect, NaviUtil.makePageNav("user.do", 202, 2, 10));
		assertEquals(page7Respect, NaviUtil.makePageNav("user.do", 202, 7, 10));
		assertEquals(page20Respect, NaviUtil.makePageNav("user.do", 202, 20, 10));
		assertEquals(page21Respect, NaviUtil.makePageNav("user.do", 202, 21, 10));
	}
